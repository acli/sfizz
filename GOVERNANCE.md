...
Given the current size of the project, we believe a horizontal organization model to be the most appropriate.
2. Decisions regarding both the technical and the organizational aspects of the project are taken unanimously between the maintainers, where anyone can obviously abstain on any decision.
3. We use GitHub as a global supporting platform for all decisions regarding the project, in the form of either pull requests or issues.
...
Considering these constraints, we chose to host the SFZ Tools organization as [a collective within Open Collective].
The Open Collective fiscal host holds the money of unincorporated partnerships such as SFZ Tools,
providing legal channels and accounting, as well as tools to support a transparent budget management by members of the collective.
...
2. The money is primarily directed towards expenses to support hosting the project – namely the website, and the continuous testing and integration platforms.
...
4. Every 3 months, during the months of March, June, September and December, the maintainers will gather in a budget meeting. The goal of the budget meeting is to decide in goodwill how to handle the money left over between contributors to the project.
5. The allocation of funds should take into account individual technical and organizational contributions.
Funds might also be allocated towards other project(s) that sfizz uses or wish to support.
...
8. The budget and expenses are kept public so all donors can keep track of how their donations are used.

Note that the Open Collective platform charges a 10% administrative fee on all donations; subsequent fees may be charged by credit card companies or by banks as the money is moved from the collective to individual accounts.
...
[a collective within Open Collective]: https://opencollective.com/sfztools
